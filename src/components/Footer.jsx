...
const Footer = () => {
  return (
    <footer className="text-center lg:text-left bg-[#051222] text-white mt-20 questrial_fnt">
    ...
    <div className="mx-6 py-10 text-center md:text-left">
        ...
        <div className="">
            ...
            <p className="mb-4">
            <a href="#!" className="text-gray-200">lorem</a>
            </p>
            <p className="mb-4">
            <a href="#!" className="text-gray-200">lorem</a>
            </p>
    ...
    <div className="text-center p-6 bg-[#051222]">
        <span>© 2022 Copyright:</span>
        <a className="text-gray-200 font-semibold"> Mobi</a>
    </div>
</footer>
  )
}
